 ...
 * 
 */
package com.qhit.lh.gr3.bella.exam.tkgl.dao;
...
import com.qhit.lh.gr3.bella.exam.common.dao.BaseDao;
...
public class QuestionDaoImpl extends BaseDao implements QuestionDao{
	...
	public WrittenQuestion getWrittenQuestionById(WrittenQuestion writtenQuestion) {
		...
		return (WrittenQuestion) getSession().get(WrittenQuestion.class, 
				writtenQuestion.getQid());
	}
