package com.qhit.lh.gr3.bella.exam.bjgl.bean;
...
import com.qhit.lh.gr3.bella.exam.xsgl.bean.Student;
...
public class ClassInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public ClassInfo(String ccode, String cname, String major, String insId, String iecId, Date cdate) {
		this.ccode = ccode;
		this.cname = cname;
		this.major = major;
		this.insId = insId;
	...
	/** full constructor */
	public ClassInfo(String ccode, String cname, String major, String insId, String iecId, Date cdate, Integer g1num,
