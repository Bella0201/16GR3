 ...
 * 
 */
package com.qhit.lh.gr3.bella.exam.sjgl.action;
...
import com.qhit.lh.gr3.bella.exam.sjgl.service.PaperService;
import com.qhit.lh.gr3.bella.exam.sjgl.service.PaperServiceImpl;
...
import com.qhit.lh.gr3.bella.exam.tkgl.utils.RandomQuestionsUtils;
...
public class PaperAction extends ActionSupport {
	...
	public String createByRandom(){
		...
		//1，查询所有的类型的试题
		listRE = questionService.getQuestionByType(course.getCsId(), "单选", "简单");
		listRN = questionService.getQuestionByType(course.getCsId(), "单选", "一般");
		listRD = questionService.getQuestionByType(course.getCsId(), "单选", "困难");
		listCE = questionService.getQuestionByType(course.getCsId(), "多选", "简单");
		listCN = questionService.getQuestionByType(course.getCsId(), "多选", "一般");
		listCD = questionService.getQuestionByType(course.getCsId(), "多选", "困难");
		//2，随机获取试题集合
